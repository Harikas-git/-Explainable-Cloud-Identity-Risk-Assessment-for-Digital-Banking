...
audit_log_path = os.path.join(PROJECT_ROOT, "database", "access_audit_log.jsonl")
...
<head>
    ...
    <title>Explainable Cloud Identity Risk Assessment | Digital Banking</title>
    <!-- Tailwind CSS CDN -->
...
<body class="bg-slate-950 text-slate-100 min-h-screen font-sans antialiased">
        ...
        <div class="flex items-center space-x-3">
            ...
            <div>
                <h1 class="text-xl font-bold tracking-tight text-white flex items-center gap-2">
                    XCIRA-DB
                    <span class="text-xs px-2.5 py-0.5 rounded-full bg-indigo-500/20 text-indigo-300 border border-indigo-500/30 font-mono">Digital Banking Zero-Trust</span>
                </h1>
                <p class="text-xs text-slate-400">Explainable Cloud Identity Risk Assessment &bull; VIT Vellore (Harika, Ashmit, Priyanshu)</p>
            </div>
        </div>
        ...
        <section class="lg:col-span-5 bg-slate-900/90 rounded-2xl border border-slate-800 p-6 shadow-xl space-y-5">
            ...
            <div class="grid grid-cols-2 gap-3 text-xs">
                <div>
                    ...
                    <input id="userId" type="text" value="alice@bank-core.internal" class="w-full bg-slate-800 rounded-lg px-3 py-1.5 border border-slate-700 text-white font-mono focus:outline-none focus:border-indigo-500">
                </div>
                <div>
                    <label class="block text-slate-400 mb-1">Banking Role</label>
                    <select id="role" class="w-full bg-slate-800 rounded-lg px-3 py-1.5 border border-slate-700 text-white focus:outline-none focus:border-indigo-500">
                        ...
                        <option>Loan Approver</option>
                        <option>Cloud Infrastructure Admin</option>
                        <option>SWIFT Payment Officer</option>
            ...
            <div class="space-y-3.5 pt-2">
                ...
                <div>
                    <div class="flex justify-between text-xs mb-1">
                        <span class="text-slate-300 font-medium">IP Threat / Proxy Risk</span>
                ...
                <div>
                    <div class="flex justify-between text-xs mb-1">
                        <span class="text-slate-300 font-medium">Resource Criticality Tier</span>
                        <span id="lbl_res_sens" class="font-mono text-indigo-400">Tier 2 (Internal Service)</span>
                    </div>
                ...
                <div class="grid grid-cols-2 gap-3 pt-1">
                    ...
                    <label class="flex items-center space-x-2 text-xs text-slate-300 bg-slate-800/60 p-2.5 rounded-lg border border-slate-700/60 cursor-pointer">
                        ...
                        <span>SWIFT / Root Elevation</span>
                    </label>
                </div>
            </div>
            ...
            <button onclick="submitEvaluation()" class="w-full py-2.5 rounded-xl font-semibold text-sm bg-gradient-to-r from-indigo-500 to-cyan-500 hover:from-indigo-600 hover:to-cyan-600 text-white shadow-lg shadow-indigo-500/25 transition">
                Evaluate Digital Banking Request
            </button>
        </section>
            ...
            <div class="bg-slate-900/90 rounded-2xl border border-slate-800 p-6 shadow-xl">
                <div class="flex flex-wrap justify-between items-center gap-4 mb-4">
                    <div>
                        ...
                        <h3 class="text-lg font-bold text-white">Dynamic Authorization Decision</h3>
                    </div>
                ...
                <div class="space-y-2">
                    <div class="flex justify-between items-end">
                        <span class="text-xs text-slate-400">Continuous Calibrated Risk Score:</span>
    ...
    <script>
        ...
        function updateSliders() {
            ...
            const resNames = ["", "Tier 1 (Public)", "Tier 2 (Internal)", "Tier 3 (Confidential Accounts)", "Tier 4 (Restricted Transfers)", "Tier 5 (SWIFT Root Secrets)"];
    ...
    def do_POST(self):
        ...
        if parsed.path == "/api/evaluate":
            ...
            req = AccessRequest(
                ...
                user_id=payload.get("user_id", "user@bank-core.internal"),
                role=payload.get("role", "Bank Teller"),
                department="Retail Banking",
                target_resource="service://swift-transfer",
...
def main():
    print(f"[*] Starting XCIRA-DB Digital Banking Console at http://localhost:{PORT}")
