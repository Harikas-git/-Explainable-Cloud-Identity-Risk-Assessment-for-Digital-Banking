"""
Synthetic IAM Access Telemetry Generator for Digital Banking
Generates realistic banking access request distributions:
- Normal routine work (Low risk - Tellers, standard hours)
- Remote / off-hours / traveling banker (Medium risk / Step-up)
...
def generate_synthetic_iam_dataset(n_samples: int = 2500, random_state: int = 42):
    """
    ...
    low_ip_rep = rng.beta(1, 25, n_low) # clustered near 0
