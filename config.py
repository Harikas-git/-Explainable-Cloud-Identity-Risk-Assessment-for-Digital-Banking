"""
Configuration and Policy Definitions for XRAC-AI
Explainable, Risk-Based Access Control Using AI
"""
from dataclasses import dataclass
from typing import Dict, List

# Policy Thresholds for Access Decisions
...
FEATURE_METADATA = {
    ...
    "resource_sensitivity": {
        "description": "Data classification level of requested resource (1: Public, 2: Internal, 3: Confidential, 4: Restricted, 5: Critical Secrets)",
        "min": 1,
        "max": 5,
        "default": 2,
        "weight_bias": 1.0
...
# System Roles and Access Matrix Defaults
DEFAULT_ROLES = ["Intern", "Software Engineer", "DevOps Admin", "Financial Officer", "Security Auditor"]
